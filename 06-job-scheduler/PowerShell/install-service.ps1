# ============================================================
# INSTALL SCHEDULED JOB RUNNER AS WINDOWS SERVICE
# ============================================================

param(
    [string]$NSSMPath = ".\nssm.exe",
    [string]$ScriptPath = ".\job-runner.ps1",
    [string]$ServiceName = "ScheduledJobRunner",
    [string]$DisplayName = "Scheduled Job Runner Service",
    [string]$Description = "Executes scheduled jobs (PowerShell, Bash, Cmd, Python) on defined schedules"
)
...
Write-Host "  cmdkey /add:JOB_RUNNER_EMAIL_CRED /user:your-email@domain.com /pass:YourPassword" -ForegroundColor White